  ...
  class RequestValidator
    ...
    def validate_params(params, operation)
      unless params.is_a?(Hash)
        raise ArgumentError.new "params instance of type #{params.class} found where Hash is expected."
      end
      ...
      when APIOperations::GET_BALANCE
        ...
        raise ArgumentError.new "Invalid operation type specified."
      end
    end
    ...
    def raise_parameter_error(param)
      raise ArgumentError.new "#{param} is required."
    end
  end
end
