...
module Eyowo
  class APIResource
    ...
    headers 'X-App-Key' => Eyowo.app_key
    ...
    def self.encrypt_data(params)
      data = params.delete_if { |k, _| k == :headers }
    ...
    def self.build_headers(params, operation)
      ...
      raise ArgumentError.new "Invalid wallet token #{params[:wallet_token]}" if params[:wallet_token].nil?
